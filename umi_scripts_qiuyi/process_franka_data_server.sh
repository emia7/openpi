...
OUTPUT_DIR="${OUTPUT_DIR:-/share/guqiuyi-local/huggingface/lerobot/$REPO_ID}"
SKIP_FAILED="${SKIP_FAILED:-true}"
...
# 执行 Python 脚本
"$PROJECT_ROOT/.venv/bin/python" umi_scripts_qiuyi/process_franka_data_server.py "${ARGS[@]}"